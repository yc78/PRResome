...
namespace Resume.DAL.Migrations
{
    ...
    [Migration("20240325204658_AddSeedDataForAboutMeTable")]
    partial class AddSeedDataForAboutMeTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Resume.DAL.Models.AboutMe.AboutMe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Bio = "",
                            BirthDate = new DateOnly(2024, 3, 26),
                            CreateDate = new DateTime(2024, 3, 26, 0, 16, 55, 380, DateTimeKind.Local).AddTicks(53),
                            Email = "",
                            FirstName = "",
                            LastName = "",
                            Location = "",
            ...
            modelBuilder.Entity("Resume.DAL.Models.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 3, 26, 0, 16, 55, 379, DateTimeKind.Local).AddTicks(9481),
